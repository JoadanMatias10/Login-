...
const CardInfoS: React.FC<CardInfoSProps> = ({ header, title, text, style = {}, className = "secondary" }) => {
  // Estilos dinámicos basados en la clase
  const cardStyles = [
    styles.card,
    className === "secondary" ? styles.secondaryBackground : styles.defaultBackground,
...
const styles = StyleSheet.create({
  ...
  secondaryBackground: {
    backgroundColor: "#6c757d", // Fondo de la tarjeta
  },
  defaultBackground: {
